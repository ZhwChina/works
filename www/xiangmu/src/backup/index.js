        ...
        success: function (msg) {
            ...
            $data.each(function (index, items) {
                for (var key in items) {
                    $banLBox.append('<div><img src=' + items[key].src + '><a href="#"><span>' + items[key].title + '</span></a><ul><li><a href = "#"> ' + items[key].urls[0].name + ' </a></li><li><a href="#"> ' + items[key].urls[1].name + '</a></li><li><a href="#">' + items[key].urls[2].name + '</a></li><li><a href="#">' + items[key].urls[3].name + '</a></li></ul></div>');
