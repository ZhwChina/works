...
//            console.log(msg)
            ...
            for( var j=0;j<num;j++){
                if($data[j]){
                    $ctn.append('<li><img src= ' + $data[j].imgs + '><span>&yen;' + $data[j].price + '</span><del>原价&yen;'+$data[j].disp+'</del><br><a href="goodsinfo.html">' + $data[j].name + '</a></li>')
                }
            }
...
//            $lis.fond('i').off('click').click(function(){
//                $(this).css('z-index','4')
//            })
        }
    })
